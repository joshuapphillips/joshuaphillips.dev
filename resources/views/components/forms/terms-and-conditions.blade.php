...
<div {{ $attributes->merge(['class' => "relative flex p-3 gap-x-3 $errorClasses"]) }}>
    ...
    <div class="text-sm leading-6">
        ...
        <p class="text-gray-500 text-xs 2xl:text-sm">By submitting your details, you confirm that you agree to the storing and processing of your personal data by {{ config('app.name')}} as described in the <a href="{{ route('terms-and-conditions') }}" target="_blank" class="underline">Terms & Conditions</a>.</p>
    </div>
</div>