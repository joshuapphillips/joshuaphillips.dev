<div class="lg:px-8 xl:px-10 ">
    <div class="mx-auto max-w-2xl">
        <h2 class="text-base font-semibold leading-7 text-indigo-600">Joshua Phillips Web Development</h2>
        <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"><span>&#128640;</span> Website Launching Soon!</h1>
        <p class="mt-6 text-lg leading-7 text-gray-600">
            Joshua Phillips is a full-stack web developer based in Somerset, England. 
            Currently working with PHP and Laravel at Onward Travel Solutions. 
    ...
    <div class="mx-auto mt-8 space-y-5">
        <x-cards.feature title="Web Applications" icon="archive-box">
            ...
            extends to developing APIs and microservices, ensuring a seamless and integrated digital ecosystem for your project.
        </x-cards.feature>
        <x-cards.feature title="Laravel" icon="archive-box">
            ...
            application development, I bring expertise in crafting end-to-end solutions.
        </x-cards.feature>
